...
function createZenithAdminOverlayStyles(): string {
  return `
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .za-menu-item { position: relative; z-index: 1; width: 12px; height: 12px; border: 0; border-radius: 999px; background: transparent; color: #f8fafc; cursor: pointer; padding: 0; display: inline-grid; place-items: center; }
    .za-menu-dot { width: 7px; height: 7px; border-radius: 999px; border: 1px solid rgba(209, 255, 244, 0.82); background: rgba(209, 255, 244, 0.82); box-shadow: none; transition: transform 150ms ease, border-color 150ms ease, background 150ms ease; }
